...
# Load the original model file (use the correct path)
model = load_model("mask_detector.model", compile=False)

# Save as .h5 format
model.save("E:/Rinku/AI/DEEP LEARNING/face mask detection/Face-Mask-Detection-master/mask_detector.h5")
...
# Save model in .h5 format (if needed)
print("Converting model to .h5 format...")
